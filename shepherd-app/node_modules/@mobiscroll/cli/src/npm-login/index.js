...
module.exports = function (user, pass, email, registry, scope, quotes, configPath, proxyUrl) {
    var finalArgs = ncl.processArguments(user, pass, email, registry, scope, quotes, configPath, proxyUrl);
    var response;
    var contents;
    var newContents;
