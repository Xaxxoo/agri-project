...
var _ActivityPostObjectAllOf = _interopRequireDefault(require("./ActivityPostObjectAllOf"));
 ...
 * @version 1.0.0
 */
var ActivityPostObject = /*#__PURE__*/function () {
  /**
   ...
   */
  function ActivityPostObject() {
    (0, _classCallCheck2["default"])(this, ActivityPostObject);
    _ActivityObjectFragment["default"].initialize(this);
    _ActivityPostObjectAllOf["default"].initialize(this);
   ...
   */
  (0, _createClass2["default"])(ActivityPostObject, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        _ActivityPostObjectAllOf["default"].constructFromObject(data, obj);
 ...
 * @member {String} subject
 */
_ActivityPostObjectAllOf["default"].prototype['subject'] = undefined;
/**
 * The type of the activity. This is in correlation with the `key_string` parameter of ActivityTypes. When value for type is not set, it will be given a default value `Call`.
 * @member {String} type
 */
_ActivityPostObjectAllOf["default"].prototype['type'] = undefined;
/**
 * The ID of the user whom the activity is assigned to. If omitted, the activity is assigned to the authorized user.
 * @member {Number} user_id
 */
_ActivityPostObjectAllOf["default"].prototype['user_id'] = undefined;
/**
 * List of multiple persons (participants) this activity is associated with. If omitted, single participant from `person_id` field is used. It requires a structure as follows: `[{\"person_id\":1,\"primary_flag\":true}]`
 * @member {Array.<Object>} participants
 */
 ...
 * @member {Array.<Object>} attendees
 */
_ActivityPostObjectAllOf["default"].prototype['attendees'] = undefined;
/**
 * Whether the activity is done or not. 0 = Not done, 1 = Done
 * @member {module:model/NumberBoolean} done
 */
