...
var _AdditionalBaseOrganizationItemInfo = _interopRequireDefault(require("./AdditionalBaseOrganizationItemInfo"));
var _BaseOrganizationItemFields = _interopRequireDefault(require("./BaseOrganizationItemFields"));
 ...
 * @version 1.0.0
 */
var BaseOrganizationItem = /*#__PURE__*/function () {
  /**
  ...
  function BaseOrganizationItem() {
    (0, _classCallCheck2["default"])(this, BaseOrganizationItem);
    _BaseOrganizationItemFields["default"].initialize(this);
    _AdditionalBaseOrganizationItemInfo["default"].initialize(this);
   ...
   */
  (0, _createClass2["default"])(BaseOrganizationItem, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        _BaseOrganizationItemFields["default"].constructFromObject(data, obj);
        _AdditionalBaseOrganizationItemInfo["default"].constructFromObject(data, obj);
 ...
 * @member {Number} id
 */
_BaseOrganizationItemFields["default"].prototype['id'] = undefined;
/**
 * The ID of the company related to the organization
 * @member {Number} company_id
 */
_BaseOrganizationItemFields["default"].prototype['company_id'] = undefined;
/**
 * @member {module:model/Owner} owner_id
 */
_BaseOrganizationItemFields["default"].prototype['owner_id'] = undefined;
/**
 * The name of the organization
 * @member {String} name
 */
_BaseOrganizationItemFields["default"].prototype['name'] = undefined;
/**
 * Whether the organization is active or not
 * @member {Boolean} active_flag
 */
_BaseOrganizationItemFields["default"].prototype['active_flag'] = undefined;
/**
 * @member {module:model/PictureDataWithValue} picture_id
 */
_BaseOrganizationItemFields["default"].prototype['picture_id'] = undefined;
/**
 * The country code of the organization
 * @member {String} country_code
 */
_BaseOrganizationItemFields["default"].prototype['country_code'] = undefined;
/**
 * The first character of the organization name
 * @member {String} first_char
 */
_BaseOrganizationItemFields["default"].prototype['first_char'] = undefined;
/**
 * The creation date and time of the organization
 * @member {String} add_time
 */
_BaseOrganizationItemFields["default"].prototype['add_time'] = undefined;
/**
 * The last updated date and time of the organization
 * @member {String} update_time
 */
_BaseOrganizationItemFields["default"].prototype['update_time'] = undefined;
/**
 * The visibility group ID of who can see the organization
 * @member {String} visible_to
 */
 ...
 * @member {Number} email_messages_count
 */
_AdditionalBaseOrganizationItemInfo["default"].prototype['email_messages_count'] = undefined;
/**
 * The count of persons related to the organization
 * @member {Number} people_count
 */
_AdditionalBaseOrganizationItemInfo["default"].prototype['people_count'] = undefined;
/**
 * The count of activities related to the organization
 * @member {Number} activities_count
 */
_AdditionalBaseOrganizationItemInfo["default"].prototype['activities_count'] = undefined;
/**
 * The count of done activities related to the organization
 * @member {Number} done_activities_count
 */
_AdditionalBaseOrganizationItemInfo["default"].prototype['done_activities_count'] = undefined;
/**
 * The count of undone activities related to the organization
 * @member {Number} undone_activities_count
 */
_AdditionalBaseOrganizationItemInfo["default"].prototype['undone_activities_count'] = undefined;
/**
 * The count of files related to the organization
 * @member {Number} files_count
 */
_AdditionalBaseOrganizationItemInfo["default"].prototype['files_count'] = undefined;
/**
 * The count of notes related to the organization
 * @member {Number} notes_count
 */
_AdditionalBaseOrganizationItemInfo["default"].prototype['notes_count'] = undefined;
/**
 * The count of followers related to the organization
 * @member {Number} followers_count
 */
_AdditionalBaseOrganizationItemInfo["default"].prototype['followers_count'] = undefined;
/**
 * The full address of the organization
 * @member {String} address
 */
_AdditionalBaseOrganizationItemInfo["default"].prototype['address'] = undefined;
/**
 * The sub-premise of the organization location
 * @member {String} address_subpremise
 */
_AdditionalBaseOrganizationItemInfo["default"].prototype['address_subpremise'] = undefined;
/**
 * The street number of the organization location
 * @member {String} address_street_number
 */
_AdditionalBaseOrganizationItemInfo["default"].prototype['address_street_number'] = undefined;
/**
 * The route of the organization location
 * @member {String} address_route
 */
_AdditionalBaseOrganizationItemInfo["default"].prototype['address_route'] = undefined;
/**
 * The sub-locality of the organization location
 * @member {String} address_sublocality
 */
_AdditionalBaseOrganizationItemInfo["default"].prototype['address_sublocality'] = undefined;
/**
 * The locality of the organization location
 * @member {String} address_locality
 */
_AdditionalBaseOrganizationItemInfo["default"].prototype['address_locality'] = undefined;
/**
 * The level 1 admin area of the organization location
 * @member {String} address_admin_area_level_1
 */
_AdditionalBaseOrganizationItemInfo["default"].prototype['address_admin_area_level_1'] = undefined;
/**
 * The level 2 admin area of the organization location
 * @member {String} address_admin_area_level_2
 */
_AdditionalBaseOrganizationItemInfo["default"].prototype['address_admin_area_level_2'] = undefined;
/**
 * The country of the organization location
 * @member {String} address_country
 */
_AdditionalBaseOrganizationItemInfo["default"].prototype['address_country'] = undefined;
/**
 * The postal code of the organization location
 * @member {String} address_postal_code
 */
_AdditionalBaseOrganizationItemInfo["default"].prototype['address_postal_code'] = undefined;
/**
 * The formatted organization location
 * @member {String} address_formatted_address
 */
_AdditionalBaseOrganizationItemInfo["default"].prototype['address_formatted_address'] = undefined;
/**
 * The count of open deals related with the item
 * @member {Number} open_deals_count
 */
_AdditionalBaseOrganizationItemInfo["default"].prototype['open_deals_count'] = undefined;
/**
 * The count of related open deals related with the item
 * @member {Number} related_open_deals_count
 */
_AdditionalBaseOrganizationItemInfo["default"].prototype['related_open_deals_count'] = undefined;
/**
 * The count of closed deals related with the item
 * @member {Number} closed_deals_count
 */
_AdditionalBaseOrganizationItemInfo["default"].prototype['closed_deals_count'] = undefined;
/**
 * The count of related closed deals related with the item
 * @member {Number} related_closed_deals_count
 */
_AdditionalBaseOrganizationItemInfo["default"].prototype['related_closed_deals_count'] = undefined;
/**
 * The count of won deals related with the item
 * @member {Number} won_deals_count
 */
_AdditionalBaseOrganizationItemInfo["default"].prototype['won_deals_count'] = undefined;
/**
 * The count of related won deals related with the item
 * @member {Number} related_won_deals_count
 */
_AdditionalBaseOrganizationItemInfo["default"].prototype['related_won_deals_count'] = undefined;
/**
 * The count of lost deals related with the item
 * @member {Number} lost_deals_count
 */
_AdditionalBaseOrganizationItemInfo["default"].prototype['lost_deals_count'] = undefined;
/**
 * The count of related lost deals related with the item
 * @member {Number} related_lost_deals_count
 */
_AdditionalBaseOrganizationItemInfo["default"].prototype['related_lost_deals_count'] = undefined;
/**
 * The date of the next activity associated with the deal
 * @member {String} next_activity_date
 */
_AdditionalBaseOrganizationItemInfo["default"].prototype['next_activity_date'] = undefined;
/**
 * The time of the next activity associated with the deal
 * @member {String} next_activity_time
 */
_AdditionalBaseOrganizationItemInfo["default"].prototype['next_activity_time'] = undefined;
/**
 * The ID of the next activity associated with the deal
 * @member {Number} next_activity_id
 */
_AdditionalBaseOrganizationItemInfo["default"].prototype['next_activity_id'] = undefined;
/**
 * The ID of the last activity associated with the deal
 * @member {Number} last_activity_id
 */
_AdditionalBaseOrganizationItemInfo["default"].prototype['last_activity_id'] = undefined;
/**
 * The date of the last activity associated with the deal
 * @member {String} last_activity_date
 */
_AdditionalBaseOrganizationItemInfo["default"].prototype['last_activity_date'] = undefined;
var _default = BaseOrganizationItem;
