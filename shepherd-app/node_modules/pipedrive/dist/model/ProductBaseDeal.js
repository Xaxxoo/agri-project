 ...
 * @version 1.0.0
 */
var ProductBaseDeal = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>ProductBaseDeal</code>.
   * @alias module:model/ProductBaseDeal
   */
  function ProductBaseDeal() {
    (0, _classCallCheck2["default"])(this, ProductBaseDeal);
   ...
   */
  (0, _createClass2["default"])(ProductBaseDeal, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('first_add_time')) {
          obj['first_add_time'] = _ApiClient["default"].convertToType(data['first_add_time'], 'String');
