...
var _BaseOrganizationItem = _interopRequireDefault(require("./BaseOrganizationItem"));
var _BaseOrganizationItemWithEditNameFlagAllOf = _interopRequireDefault(require("./BaseOrganizationItemWithEditNameFlagAllOf"));
 ...
 */
/**
 * The BaseOrganizationItemWithEditNameFlag model module.
 * @module model/BaseOrganizationItemWithEditNameFlag
 * @version 1.0.0
 */
var BaseOrganizationItemWithEditNameFlag = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>BaseOrganizationItemWithEditNameFlag</code>.
   * @alias module:model/BaseOrganizationItemWithEditNameFlag
   * @implements module:model/BaseOrganizationItem
   * @implements module:model/BaseOrganizationItemWithEditNameFlagAllOf
   */
  function BaseOrganizationItemWithEditNameFlag() {
    (0, _classCallCheck2["default"])(this, BaseOrganizationItemWithEditNameFlag);
    _BaseOrganizationItem["default"].initialize(this);
    _BaseOrganizationItemWithEditNameFlagAllOf["default"].initialize(this);
    BaseOrganizationItemWithEditNameFlag.initialize(this);
  }
   ...
   */
  (0, _createClass2["default"])(BaseOrganizationItemWithEditNameFlag, null, [{
    key: "initialize",
    value: function initialize(obj) {}

    /**
     * Constructs a <code>BaseOrganizationItemWithEditNameFlag</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BaseOrganizationItemWithEditNameFlag} obj Optional instance to populate.
     * @return {module:model/BaseOrganizationItemWithEditNameFlag} The populated <code>BaseOrganizationItemWithEditNameFlag</code> instance.
     */
  }, {
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new BaseOrganizationItemWithEditNameFlag();
        _BaseOrganizationItem["default"].constructFromObject(data, obj);
        _BaseOrganizationItemWithEditNameFlagAllOf["default"].constructFromObject(data, obj);
  ...
  return BaseOrganizationItemWithEditNameFlag;
}();
/**
...
// Implement BaseOrganizationItem interface:
/**
 * The ID of the organization
 * @member {Number} id
 */
_BaseOrganizationItem["default"].prototype['id'] = undefined;
/**
 * The ID of the company related to the organization
 * @member {Number} company_id
 */
_BaseOrganizationItem["default"].prototype['company_id'] = undefined;
/**
 * @member {module:model/Owner} owner_id
 */
_BaseOrganizationItem["default"].prototype['owner_id'] = undefined;
/**
 * The name of the organization
 * @member {String} name
 */
_BaseOrganizationItem["default"].prototype['name'] = undefined;
/**
 * Whether the organization is active or not
 * @member {Boolean} active_flag
 */
_BaseOrganizationItem["default"].prototype['active_flag'] = undefined;
/**
 * @member {module:model/PictureDataWithValue} picture_id
 */
_BaseOrganizationItem["default"].prototype['picture_id'] = undefined;
/**
 * The country code of the organization
 * @member {String} country_code
 */
_BaseOrganizationItem["default"].prototype['country_code'] = undefined;
/**
 * The first character of the organization name
 * @member {String} first_char
 */
_BaseOrganizationItem["default"].prototype['first_char'] = undefined;
/**
 * The creation date and time of the organization
 * @member {String} add_time
 */
_BaseOrganizationItem["default"].prototype['add_time'] = undefined;
/**
 * The last updated date and time of the organization
 * @member {String} update_time
 */
_BaseOrganizationItem["default"].prototype['update_time'] = undefined;
/**
 * The visibility group ID of who can see the organization
 * @member {String} visible_to
 */
 ...
 * @member {Number} email_messages_count
 */
_BaseOrganizationItem["default"].prototype['email_messages_count'] = undefined;
/**
 * The count of persons related to the organization
 * @member {Number} people_count
 */
_BaseOrganizationItem["default"].prototype['people_count'] = undefined;
/**
 * The count of activities related to the organization
 * @member {Number} activities_count
 */
_BaseOrganizationItem["default"].prototype['activities_count'] = undefined;
/**
 * The count of done activities related to the organization
 * @member {Number} done_activities_count
 */
_BaseOrganizationItem["default"].prototype['done_activities_count'] = undefined;
/**
 * The count of undone activities related to the organization
 * @member {Number} undone_activities_count
 */
_BaseOrganizationItem["default"].prototype['undone_activities_count'] = undefined;
/**
 * The count of files related to the organization
 * @member {Number} files_count
 */
_BaseOrganizationItem["default"].prototype['files_count'] = undefined;
/**
 * The count of notes related to the organization
 * @member {Number} notes_count
 */
_BaseOrganizationItem["default"].prototype['notes_count'] = undefined;
/**
 * The count of followers related to the organization
 * @member {Number} followers_count
 */
_BaseOrganizationItem["default"].prototype['followers_count'] = undefined;
/**
 * The full address of the organization
 * @member {String} address
 */
_BaseOrganizationItem["default"].prototype['address'] = undefined;
/**
 * The sub-premise of the organization location
 * @member {String} address_subpremise
 */
_BaseOrganizationItem["default"].prototype['address_subpremise'] = undefined;
/**
 * The street number of the organization location
 * @member {String} address_street_number
 */
_BaseOrganizationItem["default"].prototype['address_street_number'] = undefined;
/**
 * The route of the organization location
 * @member {String} address_route
 */
_BaseOrganizationItem["default"].prototype['address_route'] = undefined;
/**
 * The sub-locality of the organization location
 * @member {String} address_sublocality
 */
_BaseOrganizationItem["default"].prototype['address_sublocality'] = undefined;
/**
 * The locality of the organization location
 * @member {String} address_locality
 */
_BaseOrganizationItem["default"].prototype['address_locality'] = undefined;
/**
 * The level 1 admin area of the organization location
 * @member {String} address_admin_area_level_1
 */
_BaseOrganizationItem["default"].prototype['address_admin_area_level_1'] = undefined;
/**
 * The level 2 admin area of the organization location
 * @member {String} address_admin_area_level_2
 */
_BaseOrganizationItem["default"].prototype['address_admin_area_level_2'] = undefined;
/**
 * The country of the organization location
 * @member {String} address_country
 */
_BaseOrganizationItem["default"].prototype['address_country'] = undefined;
/**
 * The postal code of the organization location
 * @member {String} address_postal_code
 */
_BaseOrganizationItem["default"].prototype['address_postal_code'] = undefined;
/**
 * The formatted organization location
 * @member {String} address_formatted_address
 */
_BaseOrganizationItem["default"].prototype['address_formatted_address'] = undefined;
/**
 * The count of open deals related with the item
 * @member {Number} open_deals_count
 */
_BaseOrganizationItem["default"].prototype['open_deals_count'] = undefined;
/**
 * The count of related open deals related with the item
 * @member {Number} related_open_deals_count
 */
_BaseOrganizationItem["default"].prototype['related_open_deals_count'] = undefined;
/**
 * The count of closed deals related with the item
 * @member {Number} closed_deals_count
 */
_BaseOrganizationItem["default"].prototype['closed_deals_count'] = undefined;
/**
 * The count of related closed deals related with the item
 * @member {Number} related_closed_deals_count
 */
_BaseOrganizationItem["default"].prototype['related_closed_deals_count'] = undefined;
/**
 * The count of won deals related with the item
 * @member {Number} won_deals_count
 */
_BaseOrganizationItem["default"].prototype['won_deals_count'] = undefined;
/**
 * The count of related won deals related with the item
 * @member {Number} related_won_deals_count
 */
_BaseOrganizationItem["default"].prototype['related_won_deals_count'] = undefined;
/**
 * The count of lost deals related with the item
 * @member {Number} lost_deals_count
 */
_BaseOrganizationItem["default"].prototype['lost_deals_count'] = undefined;
/**
 * The count of related lost deals related with the item
 * @member {Number} related_lost_deals_count
 */
_BaseOrganizationItem["default"].prototype['related_lost_deals_count'] = undefined;
/**
 * The date of the next activity associated with the deal
 * @member {String} next_activity_date
 */
_BaseOrganizationItem["default"].prototype['next_activity_date'] = undefined;
/**
 * The time of the next activity associated with the deal
 * @member {String} next_activity_time
 */
_BaseOrganizationItem["default"].prototype['next_activity_time'] = undefined;
/**
 * The ID of the next activity associated with the deal
 * @member {Number} next_activity_id
 */
_BaseOrganizationItem["default"].prototype['next_activity_id'] = undefined;
/**
 * The ID of the last activity associated with the deal
 * @member {Number} last_activity_id
 */
_BaseOrganizationItem["default"].prototype['last_activity_id'] = undefined;
/**
 * The date of the last activity associated with the deal
 * @member {String} last_activity_date
 */
_BaseOrganizationItem["default"].prototype['last_activity_date'] = undefined;
// Implement BaseOrganizationItemWithEditNameFlagAllOf interface:
/**
 * If the company ID of the organization and company ID of the request is same or not
 * @member {Boolean} edit_name
 */
_BaseOrganizationItemWithEditNameFlagAllOf["default"].prototype['edit_name'] = undefined;
var _default = BaseOrganizationItemWithEditNameFlag;
