...
var _DealStrictWithMergeIdAllOf = _interopRequireDefault(require("./DealStrictWithMergeIdAllOf"));
/**
 * Pipedrive API v1
 ...
 */
/**
 * The DealStrictWithMergeId model module.
 * @module model/DealStrictWithMergeId
 * @version 1.0.0
 */
var DealStrictWithMergeId = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>DealStrictWithMergeId</code>.
   * @alias module:model/DealStrictWithMergeId
   * @implements module:model/DealStrict
   * @implements module:model/DealStrictWithMergeIdAllOf
   */
  function DealStrictWithMergeId() {
    (0, _classCallCheck2["default"])(this, DealStrictWithMergeId);
    _DealStrict["default"].initialize(this);
    _DealStrictWithMergeIdAllOf["default"].initialize(this);
    DealStrictWithMergeId.initialize(this);
  }
   ...
   */
  (0, _createClass2["default"])(DealStrictWithMergeId, null, [{
    key: "initialize",
    value: function initialize(obj) {}

    /**
     * Constructs a <code>DealStrictWithMergeId</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/DealStrictWithMergeId} obj Optional instance to populate.
     * @return {module:model/DealStrictWithMergeId} The populated <code>DealStrictWithMergeId</code> instance.
     */
  }, {
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new DealStrictWithMergeId();
        _DealStrict["default"].constructFromObject(data, obj);
        _DealStrictWithMergeIdAllOf["default"].constructFromObject(data, obj);
  ...
  return DealStrictWithMergeId;
}();
/**
 * The ID of the deal
 * @member {Number} id
 */
DealStrictWithMergeId.prototype['id'] = undefined;

/**
 * The ID of the deal creator
 * @member {Number} creator_user_id
 */
DealStrictWithMergeId.prototype['creator_user_id'] = undefined;

/**
 * The ID of the user
 * @member {Number} user_id
 */
DealStrictWithMergeId.prototype['user_id'] = undefined;

/**
 * The ID of the person associated with the deal
 * @member {Number} person_id
 */
DealStrictWithMergeId.prototype['person_id'] = undefined;

/**
 * The ID of the organization associated with the deal
 * @member {Number} org_id
 */
DealStrictWithMergeId.prototype['org_id'] = undefined;

/**
 * The ID of the deal stage
 * @member {Number} stage_id
 */
DealStrictWithMergeId.prototype['stage_id'] = undefined;

/**
 * The title of the deal
 * @member {String} title
 */
DealStrictWithMergeId.prototype['title'] = undefined;

/**
 * The value of the deal
 * @member {Number} value
 */
DealStrictWithMergeId.prototype['value'] = undefined;

/**
 * The currency associated with the deal
 * @member {String} currency
 */
DealStrictWithMergeId.prototype['currency'] = undefined;

/**
 * The creation date and time of the deal
 * @member {String} add_time
 */
DealStrictWithMergeId.prototype['add_time'] = undefined;

/**
 * The last updated date and time of the deal
 * @member {String} update_time
 */
DealStrictWithMergeId.prototype['update_time'] = undefined;

/**
 * The last updated date and time of the deal stage
 * @member {String} stage_change_time
 */
DealStrictWithMergeId.prototype['stage_change_time'] = undefined;

/**
 * Whether the deal is active or not
 * @member {Boolean} active
 */
DealStrictWithMergeId.prototype['active'] = undefined;

/**
 * Whether the deal is deleted or not
 * @member {Boolean} deleted
 */
DealStrictWithMergeId.prototype['deleted'] = undefined;

/**
 * The status of the deal
 * @member {String} status
 */
DealStrictWithMergeId.prototype['status'] = undefined;

/**
 * The success probability percentage of the deal
 * @member {Number} probability
 */
DealStrictWithMergeId.prototype['probability'] = undefined;

/**
 * The date of the next activity associated with the deal
 * @member {String} next_activity_date
 */
DealStrictWithMergeId.prototype['next_activity_date'] = undefined;

/**
 * The time of the next activity associated with the deal
 * @member {String} next_activity_time
 */
DealStrictWithMergeId.prototype['next_activity_time'] = undefined;

/**
 * The ID of the next activity associated with the deal
 * @member {Number} next_activity_id
 */
DealStrictWithMergeId.prototype['next_activity_id'] = undefined;

/**
 * The ID of the last activity associated with the deal
 * @member {Number} last_activity_id
 */
DealStrictWithMergeId.prototype['last_activity_id'] = undefined;

/**
 * The date of the last activity associated with the deal
 * @member {String} last_activity_date
 */
DealStrictWithMergeId.prototype['last_activity_date'] = undefined;

/**
 * The reason for losing the deal
 * @member {String} lost_reason
 */
DealStrictWithMergeId.prototype['lost_reason'] = undefined;

/**
 * The visibility of the deal
 * @member {String} visible_to
 */
DealStrictWithMergeId.prototype['visible_to'] = undefined;
 ...
 */
DealStrictWithMergeId.prototype['merge_what_id'] = undefined;

// Implement DealStrict interface:
/**
 * The ID of the deal
 * @member {Number} id
 */
_DealStrict["default"].prototype['id'] = undefined;
/**
 * The ID of the deal creator
 * @member {Number} creator_user_id
 */
_DealStrict["default"].prototype['creator_user_id'] = undefined;
/**
 * The ID of the user
 * @member {Number} user_id
 */
_DealStrict["default"].prototype['user_id'] = undefined;
/**
 * The ID of the person associated with the deal
 * @member {Number} person_id
 */
_DealStrict["default"].prototype['person_id'] = undefined;
/**
 * The ID of the organization associated with the deal
 * @member {Number} org_id
 */
_DealStrict["default"].prototype['org_id'] = undefined;
/**
 * The ID of the deal stage
 * @member {Number} stage_id
 */
_DealStrict["default"].prototype['stage_id'] = undefined;
/**
 * The title of the deal
 * @member {String} title
 */
_DealStrict["default"].prototype['title'] = undefined;
/**
 * The value of the deal
 * @member {Number} value
 */
_DealStrict["default"].prototype['value'] = undefined;
/**
 * The currency associated with the deal
 * @member {String} currency
 */
_DealStrict["default"].prototype['currency'] = undefined;
/**
 * The creation date and time of the deal
 * @member {String} add_time
 */
_DealStrict["default"].prototype['add_time'] = undefined;
/**
 * The last updated date and time of the deal
 * @member {String} update_time
 */
_DealStrict["default"].prototype['update_time'] = undefined;
/**
 * The last updated date and time of the deal stage
 * @member {String} stage_change_time
 */
_DealStrict["default"].prototype['stage_change_time'] = undefined;
/**
 * Whether the deal is active or not
 * @member {Boolean} active
 */
_DealStrict["default"].prototype['active'] = undefined;
/**
 * Whether the deal is deleted or not
 * @member {Boolean} deleted
 */
_DealStrict["default"].prototype['deleted'] = undefined;
/**
 * The status of the deal
 * @member {String} status
 */
_DealStrict["default"].prototype['status'] = undefined;
/**
 * The success probability percentage of the deal
 * @member {Number} probability
 */
_DealStrict["default"].prototype['probability'] = undefined;
/**
 * The date of the next activity associated with the deal
 * @member {String} next_activity_date
 */
_DealStrict["default"].prototype['next_activity_date'] = undefined;
/**
 * The time of the next activity associated with the deal
 * @member {String} next_activity_time
 */
_DealStrict["default"].prototype['next_activity_time'] = undefined;
/**
 * The ID of the next activity associated with the deal
 * @member {Number} next_activity_id
 */
_DealStrict["default"].prototype['next_activity_id'] = undefined;
/**
 * The ID of the last activity associated with the deal
 * @member {Number} last_activity_id
 */
_DealStrict["default"].prototype['last_activity_id'] = undefined;
/**
 * The date of the last activity associated with the deal
 * @member {String} last_activity_date
 */
_DealStrict["default"].prototype['last_activity_date'] = undefined;
/**
 * The reason for losing the deal
 * @member {String} lost_reason
 */
_DealStrict["default"].prototype['lost_reason'] = undefined;
/**
 * The visibility of the deal
 * @member {String} visible_to
 */
_DealStrict["default"].prototype['visible_to'] = undefined;
/**
 * The date and time of closing the deal
 * @member {String} close_time
 */
 ...
 * @member {String} won_time
 */
_DealStrict["default"].prototype['won_time'] = undefined;
/**
 * The date and time of the first time changing the deal status as won
 * @member {String} first_won_time
 */
_DealStrict["default"].prototype['first_won_time'] = undefined;
/**
 * The date and time of changing the deal status as lost
 * @member {String} lost_time
 */
_DealStrict["default"].prototype['lost_time'] = undefined;
/**
 * The number of products associated with the deal
 * @member {Number} products_count
 */
_DealStrict["default"].prototype['products_count'] = undefined;
/**
 * The number of files associated with the deal
 * @member {Number} files_count
 */
_DealStrict["default"].prototype['files_count'] = undefined;
/**
 * The number of notes associated with the deal
 * @member {Number} notes_count
 */
_DealStrict["default"].prototype['notes_count'] = undefined;
/**
 * The number of followers associated with the deal
 * @member {Number} followers_count
 */
_DealStrict["default"].prototype['followers_count'] = undefined;
/**
 * The number of emails associated with the deal
 * @member {Number} email_messages_count
 */
_DealStrict["default"].prototype['email_messages_count'] = undefined;
/**
 * The number of activities associated with the deal
 * @member {Number} activities_count
 */
_DealStrict["default"].prototype['activities_count'] = undefined;
/**
 * The number of completed activities associated with the deal
 * @member {Number} done_activities_count
 */
_DealStrict["default"].prototype['done_activities_count'] = undefined;
/**
 * The number of incomplete activities associated with the deal
 * @member {Number} undone_activities_count
 */
_DealStrict["default"].prototype['undone_activities_count'] = undefined;
/**
 * The number of participants associated with the deal
 * @member {Number} participants_count
 */
_DealStrict["default"].prototype['participants_count'] = undefined;
/**
 * The expected close date of the deal
 * @member {Date} expected_close_date
 */
_DealStrict["default"].prototype['expected_close_date'] = undefined;
/**
 * The date and time of the last incoming email associated with the deal
 * @member {String} last_incoming_mail_time
 */
_DealStrict["default"].prototype['last_incoming_mail_time'] = undefined;
/**
 * The date and time of the last outgoing email associated with the deal
 * @member {String} last_outgoing_mail_time
 */
 ...
 * @member {Number} stage_order_nr
 */
_DealStrict["default"].prototype['stage_order_nr'] = undefined;
/**
 * The name of the person associated with the deal
 * @member {String} person_name
 */
_DealStrict["default"].prototype['person_name'] = undefined;
/**
 * The name of the organization associated with the deal
 * @member {String} org_name
 */
_DealStrict["default"].prototype['org_name'] = undefined;
/**
 * The subject of the next activity associated with the deal
 * @member {String} next_activity_subject
 */
_DealStrict["default"].prototype['next_activity_subject'] = undefined;
/**
 * The type of the next activity associated with the deal
 * @member {String} next_activity_type
 */
_DealStrict["default"].prototype['next_activity_type'] = undefined;
/**
 * The duration of the next activity associated with the deal
 * @member {String} next_activity_duration
 */
_DealStrict["default"].prototype['next_activity_duration'] = undefined;
/**
 * The note of the next activity associated with the deal
 * @member {String} next_activity_note
 */
_DealStrict["default"].prototype['next_activity_note'] = undefined;
/**
 * The deal value formatted with selected currency. E.g. US$500
 * @member {String} formatted_value
 */
_DealStrict["default"].prototype['formatted_value'] = undefined;
/**
 * Probability times deal value. Probability can either be deal probability or if not set, then stage probability.
 * @member {Number} weighted_value
 */
_DealStrict["default"].prototype['weighted_value'] = undefined;
/**
 * The weighted_value formatted with selected currency. E.g. US$500
 * @member {String} formatted_weighted_value
 */
_DealStrict["default"].prototype['formatted_weighted_value'] = undefined;
/**
 * The currency associated with the deal
 * @member {String} weighted_value_currency
 */
_DealStrict["default"].prototype['weighted_value_currency'] = undefined;
/**
 * The date and time of changing the deal status as rotten
 * @member {String} rotten_time
 */
_DealStrict["default"].prototype['rotten_time'] = undefined;
/**
 * The name of the deal owner
 * @member {String} owner_name
 */
_DealStrict["default"].prototype['owner_name'] = undefined;
/**
 * The BCC email of the deal
 * @member {String} cc_email
 */
_DealStrict["default"].prototype['cc_email'] = undefined;
/**
 * If the organization that is associated with the deal is hidden or not
 * @member {Boolean} org_hidden
 */
_DealStrict["default"].prototype['org_hidden'] = undefined;
/**
 * If the person that is associated with the deal is hidden or not
 * @member {Boolean} person_hidden
 */
 ...
 * @member {Number} merge_what_id
 */
_DealStrictWithMergeIdAllOf["default"].prototype['merge_what_id'] = undefined;
var _default = DealStrictWithMergeId;
