...
var _StageWithPipelineInfoAllOf = _interopRequireDefault(require("./StageWithPipelineInfoAllOf"));
/**
 * Pipedrive API v1
 ...
 * @version 1.0.0
 */
var StageWithPipelineInfo = /*#__PURE__*/function () {
  /**
   ...
   */
  function StageWithPipelineInfo() {
    (0, _classCallCheck2["default"])(this, StageWithPipelineInfo);
    _BaseStage["default"].initialize(this);
    _StageWithPipelineInfoAllOf["default"].initialize(this);
   ...
   */
  (0, _createClass2["default"])(StageWithPipelineInfo, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        _StageWithPipelineInfoAllOf["default"].constructFromObject(data, obj);
        ...
        if (data.hasOwnProperty('pipeline_name')) {
          obj['pipeline_name'] = _ApiClient["default"].convertToType(data['pipeline_name'], 'String');
          delete data['pipeline_name'];
        }
        if (data.hasOwnProperty('pipeline_deal_probability')) {
          obj['pipeline_deal_probability'] = _ApiClient["default"].convertToType(data['pipeline_deal_probability'], 'Boolean');
 ...
 * @member {String} update_time
 */
_BaseStage["default"].prototype['update_time'] = undefined;
// Implement StageWithPipelineInfoAllOf interface:
/**
 * The name of the pipeline
 * @member {String} pipeline_name
 */
_StageWithPipelineInfoAllOf["default"].prototype['pipeline_name'] = undefined;
/**
 * The pipeline deal probability. When `true`, overrides the stage probability.
 * @member {Boolean} pipeline_deal_probability
 */
