...
import { filterClass } from '../helpers'
          ...
          >
            <Menu.Items className="absolute space-y-3 p-4 right-0 z-50 mt-2.5 w-[12rem] origin-top-right rounded-lg bg-white py-2 shadow-xl ring-1 ring-gray-900/5 focus:outline-none">
              <section>
                ...
                <div className="w-full">
                  <h3 className="text-sm text-secondaryGray mt-4 mb-2">
                    By name
                  </h3>
                    ...
                    <span
                      className={filterClass(
                        selected
                          ...
                          : 'border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700 group cursor-pointer border-b-4 py-4 px-1 text-sm font-medium',
                      )}
                    >
                      All clients
                    </span>
